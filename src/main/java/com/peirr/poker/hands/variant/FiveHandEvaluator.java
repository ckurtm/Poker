package com.peirr.poker.hands.variant;
...
/* --------------------------------------------------------------
   ...
   -------------------------------------------------------------- */
public class FiveHandEvaluator implements HandEvaluator {
   ...
   /* --------------------------------------------------------
      handRank(): return value of a hand
      -------------------------------------------------------- */
    public int handRank(Card[] h) {
   ...
   /* ===========================================================
    ...
    @Override
    public HandCategory handCategory(Card[] hand) {
